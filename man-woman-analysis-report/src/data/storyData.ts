...
export const sampleEpisodes: StoryEpisode[] = [
    {
        id: 'ep-001',
        ...
        femalePerspective: {
            text: '"알았어"는 상황을 이해했다는 게 아니야. 지금 내 감정을 정돈할 시간이 필요하니까 더 이상 변명하지 말고 기다려 달라는 신호지. 그런데 왜 갑자기 신나는 노래를 트는 걸까? 내 기분은 전혀 신경 안 쓰는 걸까?',
            thoughtBubble: '지금 라디오 틀 기분이야? 진짜 눈치 없다...'
        },
        malePerspective: {
            text: '휴, 다행히 화가 좀 풀린 모양이네. "알았어"라고 했으니 일단 이 주제는 넘어간 거겠지? 분위기 좀 살리려고 일부러 신나는 노래 틀었는데, 왜 표정이 더 안 좋아지는 것 같지... 또 내가 뭐 잘못했나?',
            thoughtBubble: '알았다고 했으면 끝난 거 아니었어? 분위기 띄우려고 했는데...'
        },
        ...
        nextTeaser: '다음 주 에피소드 예고: \'5분만 기다려\' — 그 5분이 50분이 되는 이유'
    },
    {
        id: 'ep-002',
        ...
        femalePerspective: {
            text: '진짜로 아무거나 먹고 싶은 게 아니야. 내가 지금 어떤 기분인지, 이번 주에 얼마나 피곤했는지 고려해서 센스 있게 제안해 주길 바라는 거지. 매번 나보고 정하라고 하는 건 알아보기 귀찮다는 거 아닐까?',
            thoughtBubble: '우리 기념일도 얼마 안 남았는데, 좀 특별한 데 모의해둔 곳 없어?'
        },
        malePerspective: {
            text: '진짜 아무거나 괜찮다는 줄 알았어! 이것저것 제안해도 다 거절할 거면 차라리 처음부터 스시 먹고 싶다고 말해주면 안 되나? 메뉴 고르는 게 세상에서 제일 어려워. 스무고개 하는 기분이야.',
            thoughtBubble: '아까부터 네 번이나 퇴짜 맞았어... 그냥 네가 골라 제발 ㅠㅠ'
        },
