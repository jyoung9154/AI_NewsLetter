...
작성 가이드라인:
1. 번역기 돌린 듯한 어색한 문체(예: "어색한 침묵이 흘렀다", "사랑의 저울이 아니라...")를 절대 사용하지 마세요. 한국의 2030 세대가 인터넷 커뮤니티나 카톡에서 쓰는 트렌디하고 자연스러운 구어체를 사용하세요.
...
아래 JSON 구조로 작성:
{
  ...
  "situation": "2~3줄 상황 묘사 (아주 구체적이고 현실적인 상황 설정, 예: 홍대 파스타집에서 계산서를 사이에 둔 3초의 침묵)",
  "female_text": "여자 시점 2~3문장 (겉으로 하는 말이나 행동 묘사, 자연스러운 구어체)",
  "female_thought": "여자 속마음 한 줄 (진짜 속내, 팩트)",
  "male_text": "남자 시점 2~3문장 (겉으로 하는 말이나 뚝딱거리는 행동 묘사, 구어체)",
  "male_thought": "남자 속마음 한 줄 (진짜 속내, 팩트)",
  "resolution": "결론 + 뼈 때리면서도 위트 있는 한 줄 요약",
  "advice": "남자 팁: (내일 당장 쓸 수 있는 현실적 멘트나 행동) / 여자 팁: (현실적 마인드셋이나 행동)",
