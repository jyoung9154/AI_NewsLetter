...
export async function generateMetadata({ params }: { params: { episode_number: string } }): Promise<Metadata> {
    const supabase = getSupabaseService();
    const episodeNum = parseInt(params.episode_number, 10);
    ...
    return {
        ...
        openGraph: {
            ...
            description,
            type: 'article',
            url: `https://man-woman-analysis-report.vercel.app/episodes/${episode.episode_number}`,
...
export default async function EpisodePage({ params }: { params: { episode_number: string } }) {
    const supabase = getSupabaseService();
    const episodeNum = parseInt(params.episode_number, 10);
